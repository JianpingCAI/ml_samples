...
namespace MLNET_sample1ML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\PersonalRepos\ml_samples\ML.NET_samples\MLNET_sample1\MLNET_sample1\wikipedia-detox-250-line-data.tsv";
